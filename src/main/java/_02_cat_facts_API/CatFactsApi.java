...
import _02_cat_facts_API.data_transfer_objects.Result;
...
public class CatFactsApi {
    ...
    public CatWrapper getCatFact() {
    	...
    	CatWrapper data = webClient.get().retrieve().bodyToMono(CatWrapper.class).block();
        //return the Object
        return data;
    ...
    public String findCatFact(){
    	...
    	List<String> catFact = catWrapper.getData();
    	String message = catFact.get(0);
        return message;
    }
